...
** PATH .envrc
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/.envrc"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/.envrc][.envrc]]
:END:
#+call: make-file-path()
direnv integration
#+begin_src conf
...
** PATH .gitignore
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/.gitignore"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/.gitignore][.gitignore]]
:END:
#+call: make-file-path()
#+begin_src conf
# env files
...
** PATH pyproject.toml
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/pyproject.toml"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/pyproject.toml][pyproject.toml]]
:END:
#+call: make-file-path()
#+begin_src conf-toml
[build-system]
...
** PATH setup.cfg
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/setup.cfg"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/setup.cfg][setup.cfg]]
:END:
#+call: make-file-path()
#+begin_src conf-toml
[metadata]
...
** PATH README.md
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/README.md"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/README.md][README.md]]
:END:
#+call: make-file-path()
#+begin_src markdown
# <<project-name>>
...
** PATH .python-version
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/.python-version"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/.python-version][.python-version]]
:END:
#+call: make-file-path()
Name of pyenv venv
#+begin_src conf
...
:file-path: "/home/chunglak/projects/python_package_template/bin"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/bin][bin]]
:END:
#+call: make-file-path()
#+call: make-dir()
...
*** PATH mypy.ini
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/bin/mypy.ini"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/bin/mypy.ini][mypy.ini]]
:END:
#+call: make-file-path()
#+begin_src conf
  [mypy]
...
:PROPERTIES:
:file-path: "/home/chunglak/projects/orgee-roam-extdata/bin/setup-python-pyenv"
:file-path-link: [[file:/home/chunglak/projects/orgee-roam-extdata/bin/setup-python-pyenv][setup-python-pyenv]]
:END:
#+call: make-file-path()
...
** PATH src
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/src"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/src][src]]
:END:
#+call: make-file-path()
#+call: make-dir()
Put code here
** PATH tests
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/tests"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/tests][tests]]
:END:
#+call: make-file-path()
#+call: make-dir()
Put test suite here
...
** PATH org
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/org"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/org][org]]
:END:
#+call: make-file-path()
No need to create this dir: it should pre-exist
*** PATH template.org
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/org/template.org"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/org/template.org][template.org]]
:END:
#+call: make-file-path()
...
*** PATH upload-to-pypi
:PROPERTIES:
:file-path: "/home/chunglak/projects/python_package_template/bin/upload-to-pypi"
:file-path-link: [[file:/home/chunglak/projects/python_package_template/bin/upload-to-pypi][upload-to-pypi]]
:END:
#+call: make-file-path()
#+begin_src bash :shebang #!/bin/bash
set -eu
